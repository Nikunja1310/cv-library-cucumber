...
@sanity @regression
 Scenario Outline: User should be able to verify Job Search Result Using Different Data Set
   ...
   Examples:
     ...
     |Software Tester   |Birmingham             |5 miles       |40000        |60000       |Per annum      |Permanent   |Permanent It Developer jobs in Birmingham     |
     |Automation Tester |Bristol(County)        |5 miles       |40000        |50000       |Per annum      |Permanent   |Permanent Automation Tester jobs in Bristol (County)|
     |Business analyst  |Cardiff                |5 miles       |30000        |60000       |Per annum      |Permanent   |Permanent Business Analyst jobs in Cardiff        |